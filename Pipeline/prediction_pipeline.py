...
def openvino_predict(
        model_bin=dsl.PipelineParam(
            name='model-bin-path', value='s3://212.227.4.254:9000/models/resnet_50_i8.bin'),
        model_xml=dsl.PipelineParam(
            name='model-xml-path', value='s3://212.227.4.254:9000/models/resnet_50_i8.xml'),
        generated_model_dir=dsl.PipelineParam(
            name='generated-model-dir', value='s3://212.227.4.254:9000/output'),
        input_numpy_file=dsl.PipelineParam(
            name='input-numpy-file', value='s3://212.227.4.254:9000/generated-models/imgs.npy'),
        label_numpy_file=dsl.PipelineParam(
            name='label-numpy-file', value='s3://212.227.4.254:9000/generated-models/lbs.npy'),
